defmodule DoAuth.Crypto do
  @moduledoc """
  This module contains all the cryptographic functions used by DoAuth.
  """
  ...
  @typedoc """
  Derivation limits type.
  Currently used in default_params function and slip type.
  They govern how many instructions and how much memory is allowed to be consumed by the system.
  """
